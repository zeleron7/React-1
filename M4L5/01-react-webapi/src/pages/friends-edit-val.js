...
export function FriendsEditVal()
{
...
export function FriendsEditValList() {
...
export function FriendsEditValView() {
    ...
    const onEdit = (e) => 
    {
      navigate(`/friends-edit-val/${id}/edit`);
    }
    const onUndo = (e) => 
    {
      navigate(`/friends-edit-val`);
    }  
  ...
  export function FriendsEditValEdit() {
