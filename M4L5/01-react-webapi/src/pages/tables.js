...
import TableAsClass from '../components/table-as-class';
import TableAsFunc from '../components/table-as-func';
...
export function Tables()
{
     return (
        <div className="container px-4 py-4 text-start">
            ...
            <h2 className="pb-2 border-bottom">Tables with props</h2>
            <Outlet/>
...
export function TableList() {
    ...
    return (
      <>
        ...
        <TableAsClass headers={tableHeaders} initialData={tableData} onDoubleClick={onDoubleClick}/>

        <br/>
        <h1>Table as a func component</h1>
        <TableAsFunc headers={tableHeaders} initialData={tableData} onDoubleClick={onDoubleClick}/>
      </>
    );
  }
